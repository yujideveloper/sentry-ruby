...
- [Add](Add) new boolean option `config.enable_tracing` to simplify enabling performance tracing [#2005](https://github.com/getsentry/sentry-ruby/pull/2005)
  ...
  - `config.enable_tracing = nil` will keep the current behaviour
